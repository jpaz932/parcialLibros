                ...
                <div class="card-body">
                    <form method="post" action="{{ route('books.update', $book) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="publication_year" name="publication_year" value="{{ old('publication_year', $book->publication_year) }}">
                        </div>
                        <div class="form-group">
